...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action=""  method="POST"  class="form" >
               ...
               <div class="inputBox">
                <h3> Location</h3><input type="text" value="Chamoli" 
...
<h3 class="Payments">Payment Bus
    <br>
        ...
        Rs.<input type="" id="price" value="3000" name="price" class="price" readonly="" >  
            ...
            <div class="inputBox">
                <h3>arrivals</h3>
                <input type="date" name="arrivals" min="2022-01-14">
            </div>
            <div class="inputBox">
                <h3>leaving</h3>
                <input type="date" name="leaving" min="2022-01-14">
            </div>
...
<script>
     //setting default attribute to disabled of minus button
        ...
        // const.getElementById("name").addEventListener("click",function(){
        //     value.trim()
        // })
